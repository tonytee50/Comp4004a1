...
public class TestLoanTable {
	...
	public void testRenewal() {
		...
		System.out.println(loanTable.loanList.get(4).getUserid());
		System.out.println(loanTable.loanList.get(4).getIsbn());
		System.out.println(loanTable.loanList.get(4).getCopynumber());
